...
public class RequestHelper
{
	...
	static let urlAPI:String = "\(Environment.shared.configuration(.ConnectionProtocol))://\(Environment.shared.configuration(.ServerURL))"
	...
	static func route(_ route: String) -> String
	{
		let endpoint = "\(RequestHelper.urlAPI)/\(route)"
		return endpoint
	}
